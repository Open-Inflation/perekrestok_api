...
class CatalogFeedFilter:
    ...
    SUB_CATEGORY_ID = Filter(-1, int, "category")  # 1389 - "Фрукты, овощи: акции и скидки"
    """ID категорий бывают 2 видов - главные и дочерние. Оба - просто числа, но система примет только подкатегорию."""
